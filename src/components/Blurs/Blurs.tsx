            ...
            <div key={b.name} style={{ display: 'flex', gap: '2rem', padding: '1.5rem', borderBottom: '1px solid #f0f0f0', alignItems: 'flex-start' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', flex: 1 }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem 1rem', marginTop: '0.25rem', alignItems: 'center' }}>
                  <span style={{ fontSize: '0.8rem', color: '#555', fontFamily: 'monospace' }}>{b.blurType === 'background' ? 'backdrop-filter' : 'filter'}</span>
                  <span style={{ fontSize: '0.8rem', color: '#ccc' }}>{"·"}</span>
                  <span style={{ fontSize: '0.8rem', color: '#555', fontFamily: 'monospace' }}>blur({b.radius}px)</span>
                  <span style={{ fontSize: '0.8rem', color: '#ccc' }}>{"·"}</span>
                  <span style={{ fontSize: '0.8rem', color: '#888', fontFamily: 'monospace' }}>type: {b.blurType}</span>
                </div>
              </div>
            </div>
          ))}
